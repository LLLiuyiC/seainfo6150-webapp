  ...
  return (
    <html lang="en">
     ...
     <body>
      ...
      <section>
       <header>
        <h1><strong>The Statue of Liberty's torch heads to new museum</strong></h1>
        <br />
        <address>
      ...
      <section>
       ...
       <p>
      Not only is the Statue of Liberty the symbol of New York City, she is also a UNESCO World Heritage site under the designation of <i>_Outstanding Universal Value_</i>.
       </p>
       <p>
      ...
      <section>
       ...
       <p>
      * Total overall height from the base of the pedestal foundation to the tip of the torch is <b>305 feet, 6 inches</b><br />

      * Height of the Statue from her heel to the top of her head is 111 feet, 6 inches<br />

      * The Statue has a <b>35-foot</b> waistline<br />

      * Total weight of the Statue of Liberty is <b>225 tons (or 450,000 pounds)</b><br />
       </p>
      </section>
    </main>
   </body>
